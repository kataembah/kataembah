       ...
       <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                  <li class="active" ><a href="#"><i class="fa fa-camera"></i> Bukti Transfer  <span class="label label-danger pull-right"><?php echo $verifikasi ?></span> </a></li>
                </li>
                 <li><a href="<?php echo base_url()?>Admin/setting/rekening"><i class="fa fa-money"></i> Rekening Saya  <span class="label label-success pull-right"><?php echo $pengemasan ?></span></a></li>
