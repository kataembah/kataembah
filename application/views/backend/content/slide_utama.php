    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form method="POST" action="simpan_utama" enctype="multipart/form-data">
          </div>
          <!-- /.box-header -->
      ...
      <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                 <li ><a href="<?php echo base_url()?>Admin/slide"><i class="fa fa-image"></i> SLIDE  </a></li>
                </li>
                 <li  class="active"><a href="#"><i class="fa fa-image"></i> SLIDE UTAMA </a></li>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Slide Utama</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              foreach ($datakks->result() as $row) { 
                ...
                <tr>
                  ...
                  <td><center><?php echo $row->deskripsi ?></center> </td>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Edit Data</h4>
           ...
           <form method="POST" action="../slide/ubah1" enctype="multipart/form-data">
