        ...
        <div class="col-sm-12 col-md-12">
            <div class="single-blog single-column">
                <div class="post-thumb">
                    <a href="<?= site_url('dashboard/blogDetail') ?>"><img src="<?= base_url() ?>asset/images/blog/7.jpg" class="img-responsive" alt=""></a>
                    <div class="post-overlay">
                       <span class="uppercase"><a href="#">14 <br><small>Feb</small></a></span>
                   </div>
                </div>
                <div class="post-content overflow">
                    <h2 class="post-title bold"><a href="<?= site_url('dashboard/blogDetail') ?>">Advanced business cards design</a></h2>
